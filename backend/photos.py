"""Photo storage for delivery-outcome proof photos. The platform provides no
object storage, so photos live as LONGBLOB rows in OceanBase; the frontend
resizes/compresses client-side before upload to keep row sizes reasonable."""
import io
